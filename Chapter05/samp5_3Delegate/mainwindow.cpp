...
void MainWindow::iniModelData(QStringList &aFileContent)
{
    ...
    QStringList headerList=header.split(QRegularExpression("\\s+"),QString::SkipEmptyParts);     //Qt6中的代码
    ...
    for (int i=1;i<rowCnt;i++)
    {
        ...
        QStringList tmpList=aLineText.split(QRegularExpression("\\s+"),QString::SkipEmptyParts);////Qt6中的代码
