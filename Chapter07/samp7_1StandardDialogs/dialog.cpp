...
void Dialog::on_btnProgress_clicked()
{
    ...
    dlgProgress.setWindowModality(Qt::WindowModal); // 以模态的方式显示对话框
    ...
    for(int i = minV;  i<= maxV; ++i){
        dlgProgress.setValue(i);    // 进度条自动刷新显示
...
void Dialog::do_progress_canceled()
{
    ...
    ui->plainTextEdit->appendPlainText("**进度对话框被取消**");
}
...
void Dialog::on_btnMsgQuestion_clicked()
{
    ...
    result = QMessageBox::question(this, dlgTitle, strInfo, QMessageBox::Yes|
...
{
    QMessageBox::aboutQt(this, "Qt信息消息框");
}
